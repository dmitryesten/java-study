...
public class PairBoxTest {
    ...
    public void isSameSquare() throws Exception {
        PairBox<Rectangle, Circle> pairBox1 = new PairBox<>(new Rectangle(), new Circle(1,1,1, (Color) null));

        assertEquals(new Rectangle(), pairBox1.getContentRect() );
        assertEquals(new Circle(1,1,1, (Color) null), pairBox1.getContentCircle());
